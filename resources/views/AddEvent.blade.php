				...
				<div class="login-page-contant">
					<form class="submit-forms" action="/login" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="short-desc" placeholder="Short description about Event"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1" class="label">Event-Full Description</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="full-desc" placeholder="Full description about Event"></textarea>
                        </div>
                         <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between" id="forgotpassword">
							<div>
								<a id="our-back-button" class="btn btn-md btn-light" href="{{ url('/home') }}">Back</a> 
							</div>
							<div>
