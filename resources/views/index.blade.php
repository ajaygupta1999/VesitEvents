                        ...
                        <div class="upper-content d-flex flex-column">
                            ...
                            <p class="guest-text"><span>Guest:</span>
                                @for($j=0 ; $j < sizeof($guests_ids) ; $j++)
                                    @php
                                        $guest = \App\Models\Guest::find($guests_ids[$j]->guest_id)->first();
                            ...
                            <div class="date-time-div d-flex justify-content-start align-items-center">
                                ...
                                <form action="event/{{$ongoing_events[$i]->id}}">
                                    <div class="register-button-div">
                                        <button type="submit" id="each-event-register-button" class="btn btn-md btn-primary">Register</button>
                                    </div>
                                </form>
                    </div>
                </div>
                ...
                <div class="each-event-container">
                    ...
                    <div class="content-session">
                        <div class="upper-content d-flex flex-column">
                            ...
                            <form action="event/{{$upcoming_events[$i]->id}}">
                            <div class="register-button-div">
                                <button type="submit" id="each-event-register-button" class="btn btn-md btn-primary">Register</button>
                            </div>
                            </form>
